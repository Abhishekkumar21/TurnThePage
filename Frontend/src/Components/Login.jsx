  ...
  return (
    <>
      <div>
        ...
        <dialog id="my_modal_3" classNameName="modal">
          <div classNameName="modal-box dark:bg-slate-600 ">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button classNameName="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">
                ✕
              </button>
            </form>
            <h1 classNameName="font-semibold text-2xl md:text-4xl justify-center flex dark:text-gray-200">
              Log In
            </h1>
            <div classNameName="pt-4s space-y-4">
              <div>
